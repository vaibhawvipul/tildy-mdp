...
def changeState(currentState,UserInput):
    ...
    # if current State is A and user presses 2, 80% chances that it goes to B and 20% that it comes back to A. small negative reward.
        ...
        if current_state=="A":
            ...
            rewards("small neg")
    # if current state is B and user presses 1, 80% chances that it goes to A and 20% that it comes back to B. big reward.
        ...
        if current_state=="B":
            ...
            rewards("big pos")
    # if current state is B and user presses 1, 80% chances that it goes to A and 20% that it comes back to B. small reward.
...
if __name__=="__main__":
    while True:
        printMsg(mdp)
        userInput = int(input()) # put a check that user enters 1 or 2.
